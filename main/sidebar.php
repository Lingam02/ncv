<div class="bg-white non-print shadow" id="sidebar-wrapper">
  ...
  <div class="collapse" id="toggle_opn">
    ...
    <a href="opening_raw.php">Raw Store Opening</a>
    <a href="opening1.php">Dyed Silk Store Opening</a>
    <a href="opening2.php">Bobin Store Opening</a>
    <a href="opening3.php">Pirn Store Opening</a>
  ...
  <div class="list-group list-group-flush my-3">
    ...
    <a href="sizeing.php" class="list-group-item list-group-item-action second-text "><i class="fas fa-layer-group me-2"></i>Return from Zari Warping Section</a>
    <a href="sizeing.php" class="list-group-item list-group-item-action second-text "><i class="fas fa-layer-group me-2"></i>Transfer to Rolling Section</a>
    <a href="sizeing.php" class="list-group-item list-group-item-action second-text "><i class="fas fa-layer-group me-2"></i>Return from Rolling Section</a>
    ...
    <a href="rawissueto_bobin.php" class="list-group-item list-group-item-action second-text fw-bold"><i class="fas fa-arrow-right me-2"></i>Transfer to <span style="color:blue">Bobin Section</span></a>
    <a href="rawreturnfrom_bobin.php" class="list-group-item list-group-item-action second-text fw-bold"><i class="fas fa-arrow-left me-2"></i>Return from <span style="color:blue">Bobin Section</span></a>

    <a href="rawissueto_pirn.php" class="text-nowrap list-group-item list-group-item-action second-text fw-bold"><i class="fas fas fa-arrow-right me-2"></i>Transfer to <span style="color:orange">Pirn Section</span></a>
    <a href="rawreturnfrom_pirn.php" class="list-group-item list-group-item-action second-text fw-bold"><i class="fas fas fa-arrow-left me-2"></i>Return from <span style="color:orange">Pirn Section</span></a>
    ...
    <a href="logout.php" class="list-group-item list-group-item-action text-danger fw-bold"><i class="fas fa-power-off me-2"></i>Logout</a>
    ...
    <div class="collapse" id="report_toggle">
      ...
      <a href="opening_report1.php"> Separation Store</a>
      <a href="opening_report1.php"> Dyeing Store</a>
      <a href="opening_report1.php"> Dyed Silk Store</a>
      <a href="opening_report1.php"> Sizing Store</a>
      <a href="opening_report1.php"> Zari Warp Store</a>
      <a href="opening_report1.php"> Rolling Store</a>
      <a href="opening_report1.php"> Bobin Store</a>
      <a href="opening_report1.php"> Pirn Store</a>
      <a href="opening_report1.php"> Loom Section</a>
    ...
    <a href="opening_report1.php" class="list-group-item list-group-item-action text-dark"><i class="fas fa-arrow-right me-2"></i>
      Dyed Silk Store Openings
    </a>
    <a href="opening_report_net.php" class="list-group-item list-group-item-action text-dark"><i class="fas fa-arrow-right me-2"></i>
      Bobin Store Openings
    </a>
