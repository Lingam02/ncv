...
<body>
  ...
  <div class="container" id="dyedsilkstore">
    <h4 class="text-center mt-2 text-success">Opening Balance of Dyed Silk Store</h4>
      ...
      <div class="row">
        ...
        <div class="my-2 col-md-12">
          ...
          <datalist id="locations">
            <?php
            $sql = mysqli_query($con, "SELECT id, loc_nam FROM stock_stores WHERE loc_nam = 'DYED SILK STORE' order by loc_nam");
