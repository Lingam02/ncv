 ...
 <?php
    ...
    $sql2 = "SELECT * FROM tbl_opening where itm_type = 'PS' and tbl_type = 'WEFTPS';"; // Default query to retrieve all users
    $result2 = $con->query($sql2);

    $sql3 = "SELECT * FROM tbl_opening where itm_type = 'PS' and tbl_type = 'ZARIPS';"; // Default query to retrieve all users
                 ...
                 <button onclick="printTableContainer()" id="print" class="non-print">Print</button>
                     ...
                     <div class="tbl_2">
                         <table>
                             <thead>
                                 <tr>
                                     <td class="tbl_heading" colspan="5">Weft Opening Stock in grams</td>
                                 </tr>
                                 <tr>
                                     <th>S.NO</th>
                                     <th>Location</th>
                     ...
                     <div class="tbl_3">
                         <table>
                             <thead>
                                 <tr>
                                     <td class="tbl_heading" colspan="5">Zari Opening Stock in grams</td>
                                 </tr>
                                 <tr>
                                     <th>S.NO</th>
                                     <th>Location</th>
