    ...
    <script>
      window.onload = function() {
        ...
        if (success === '1') {
          ...
          snackbar.textContent = "Box No Created successfully";
  ...
  <body>
              ...
              <table>
                <thead>
                  <tr text-align:center;font-weight:600>
                    <td class="tbl_heading" colspan="4">Empty Boxes</td>
                  </tr>
                  <tr>
                    <th>S.No</th>
                    <!-- <th>Id</th> -->
    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <input type="text" list="iss_col_list" class="form-control" id="box_no_edit" name="box_no_edit" placeholder="" onclick="this.select()">
