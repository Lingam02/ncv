 ...
 <?php
    ...
    $sql = "SELECT * FROM tbl_opening where itm_type = 'DSS' and tbl_type = 'WARP';"; // Default query to retrieve all users
    $result = $con->query($sql);

    $sql2 = "SELECT * FROM tbl_opening where itm_type = 'DSS' and tbl_type = 'WEFT';"; // Default query to retrieve all users
    $result2 = $con->query($sql2);

    $sql3 = "SELECT * FROM tbl_opening where itm_type = 'DSS' and tbl_type = 'ZARI';"; // Default query to retrieve all users
                 ...
                 <button onclick="printTableContainer()" id="print" class="non-print">Print</button>
                         ...
                         <table>
                             <thead>
                                 <tr text-align:center;font-weight:600>
                                     <td class="tbl_heading" colspan="4">Warp Opening Stock in grams</td>
                                 </tr>
                                 <tr>
                                     <th>S.NO</th>
                                     <th>Location</th>
                     ...
                     <div class="tbl_2">
                         <table>
                             <thead>
                                 <tr>
                                     <td class="tbl_heading" colspan="4">Weft Opening Stock in grams</td>
                                 </tr>
                                 <tr>
                                     <th>S.NO</th>
                                     <th>Location</th>
                     ...
                     <div class="tbl_3">
                         <table>
                             <thead>
                                 <tr>
                                     <td class="tbl_heading" colspan="4">Zari Opening Stock in grams</td>
                                 </tr>
                                 <tr>
                                     <th>S.NO</th>
                                     <th>Location</th>
